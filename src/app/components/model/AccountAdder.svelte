...
<div class="account-adder-container">
    <div class="wrapper account-type-option-container">
        <div class="container-header">
            <span class="c-title">{$t('accountAdder.addOfflineAccount')}</span>
            <SimpleTip text={$t('accountAdder.close')} direction="bottom">
                <button class="c-close-btn" aria-label={$t('accountAdder.close')} on:click={close} disabled={submitting}>
            ...
            <div class="offline-account-form">
                <form class="input-form" on:submit={submitOffline}>
                    ...
                    <div class="button-group">
                        ...
                        <button type="submit" class="btn-accent" disabled={submitting || !isUsernameValid}>
                            {#if submitting}
