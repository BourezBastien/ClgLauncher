<script>
    ...
    import { loadNewsOnce, newsFeed, newsLoaded } from "../../stores/news";
        ...
        .bottom-group {
            ...
            .rss-wrapper {
                ...
                .wrapper {
                    ...
                    .thumbnail.view-more-bg {
                        display: flex;
                        align-items: center;
                        justify-content: center;
                        background: linear-gradient(to right, var(--base-color), var(--base-color), color-mix(in srgb, var(--base-color), transparent 14%), color-mix(in srgb, var(--base-color), transparent 14%)), url(./images/static/elven-village.webp);
                        color: var(--text-color);
                        font-weight: bold;
                        font-size: 1em;
                    ...
                    .thumbnail.view-more-bg:hover {
                        background: linear-gradient(to right, var(--base-color), var(--base-color), color-mix(in srgb, var(--base-color), transparent 14%), color-mix(in srgb, var(--base-color), transparent 40%), color-mix(in srgb, var(--base-color), transparent 40%)), url(./images/static/elven-village.webp);
                        font-size: 1.3rem;
                    }
